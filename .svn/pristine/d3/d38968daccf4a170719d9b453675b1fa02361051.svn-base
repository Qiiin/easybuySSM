...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <!--[if IE 6]>
    <script src="statics/common/js/iepng.js" type="text/javascript"></script>
...
<div class="i_bg">  
    <div class="content mar_20">
    	<img src="statics/images/img2.jpg" />        
    </div>
    	...
    	<div class="two_bg">
        	...
        	<c:forEach items="${sessionScope.cart.items}" var="temp">
                ...
                <td>
                    ...
                    ${temp.product.name} ${temp.product.describe}
                </td>
              ...
              <tr>
                <td colspan="5" align="right" style="font-family:'Microsoft YaHei';">
                    商品总价：￥${sessionScope.cart.sum} ； 返还积分 56R  
                </td>
              </tr>
            </table>
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              ...
              <tr>
              	<td align="center"><input type="checkbox" name="pack" checked="checked" value="0"/></td>
              ...
              <tr>
              	<td align="center"><input type="checkbox" name="pack" value="1" /></td>
            ...
            <table border="0" class="car_tab" style="width:1110px;" cellspacing="0" cellpadding="0">
              ...
              <tr>
              	<td align="center"><input type="checkbox" name="wish" value ="0" checked="checked" /></td>
              ...
              <tr>
              	<td align="center" style="border-bottom:0; padding-bottom:0;"><input type="checkbox" name="wish" value ="1" /></td>
            ...
            <table border="0" style="width:900px; margin-top:20px;" cellspacing="0" cellpadding="0">
              ...
              <tr height="70">
                <td align="right"><a href="#"><img src="statics/images/btn_sure.gif" onclick="confirmOrder();" /></a></td>
              </tr>
            </table>
