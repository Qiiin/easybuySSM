...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    ...
    <script type="text/javascript" src="../statics/js/common/producCategory.js"/>           
	<script type="text/javascript" src="../statics/js/common/n_nav.js"></script>    
    <script type="text/javascript" src="../statics/js/common/num.js">
    	var jq = jQuery.noConflict();
    </script>    
 <!--    <script type="text/javascript" src="statics/js/common/shade.js"></script>
     -->
    
<!--     <script type="text/javascript" src="js/jquery-3.3.1.js"></script>
 -->    <script type="text/javascript" src="../statics/js/common/js/menu.js"></script>    
          
	<script type="text/javascript" src="../statics/js/common/js/lrscroll_1.js"></script>
...
<div class="soubg">
	<div class="sou">
        ...
        <!--End 所在收货地区 End-->
        <span class="fr">
        	<span class="fl">你好，请<a href="backend/productServlet?action=getProductList">登录</a>&nbsp; <a href="Regist.html" style="color:#ff4e00;">免费注册</a>&nbsp;|&nbsp;<a href="#">我的订单</a>&nbsp;|</span>
        	<span class="ss">
            	<div class="ss_list">
                	<a href="#">收藏夹</a>
...
<div class="top">
    ...
    <div class="i_car">
        ...
        <div class="car_bg">
       		<!--Begin 购物车未登录 Begin-->
        	<div class="un_login">还未登录！<a href="#" class ="rn_login" style="color:#ff4e00;">马上登录</a> 查看购物车！</div>
            <!--End 购物车未登录 End-->
            <!--Begin 购物车已登录 Begin-->
            <ul class="cars">
            	<li>
    ...
    <div class="content mar_20">
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          <c:forEach items="${sessionScope.cart.items}" var="temp" varStatus="status">
            ...
            <td align="center"><a href="javascript:void(0);" onclick="removeShoppingCartItem(${temp.product.id});">删除</a>&nbsp; &nbsp;<a href="#">加入收藏</a></td>
          </tr>
 ...
 */		//$.post("CarServlet","action=toSettlement","html");
         ...
         +" </tr>"
 		 ...
 		 +"<tr valign=\"top\" height=\"150\">"
          	+"<td colspan=\"6\" align=\"right\">"
            +"<a href=\"../CategoryList.jsp\"><img src=\"../statics/images/buy1.gif\" /></a>&nbsp; &nbsp; <a href=\"../buycar_two.jsp\"><img src=\"../statics/images/buy2.gif\" /></a>"
            +"</td>"
         +"</tr>"
 		);
	}
 ...
 */		jq.ajax({
			...
			jq(".car_tab").find(".fr").children("b").html("￥"+data);
			}
		});
};
/*商品数量增加 */
